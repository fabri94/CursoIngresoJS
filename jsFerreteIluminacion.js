...
function CalcularPrecio () 
{
	...
	cantidadDeLamparas=parseInt(cantidadDeLamparas); /* a partir de este momento cantidadDeLamparas es un numero */
	...
	console.info(precioConDescuento);
