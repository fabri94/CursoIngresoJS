...
function mostrar()
{
	...
	do
	{
		...
		acumuladorImporteBruto=acumuladorImporteBruto+importeBruto;
	...
	importeConDescuento=acumuladorImporteBruto-(acumuladorImporteBruto)*(descuento/100);
	promedioPrecioPorKilo=acumuladorImporteBruto/acumuladorPeso;

	console.log("El importe bruto por la compra sera: "+acumuladorImporteBruto);
